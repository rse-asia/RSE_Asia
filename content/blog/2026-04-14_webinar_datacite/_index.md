...
![*Image: List of resource types that can me get a DOI via DataCite Fabrica, including ‘Software’*](image_1_software_introduced.png)
...
![*Image: Increased reporting of software as a research output since 2017, when it was first made a research output type in DataCite Fabrica.*](image_2_software_growth.png)
...
![*Image: Top 10 repositories that contribute Software outputs to DataCite Fabrica*](image_3_repositories.png)
...
![*Image: DataCite Metadata schema*](image_4_metadata_schema.png)
...
![*Image: Connection metadata*](image_5_connection_metadata.png)
...
![*Image: PID graph*](image_6_pid_graph.png)
*Image: PID graph*
