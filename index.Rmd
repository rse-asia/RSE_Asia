...
[![Open Life Science Logo](images/ols-transparent-bg.png){width=10%}](https://openlifesci.org/) $~$     [![Society of Research Software Engineering  Logo](images/Soc_RSE_Logo.png){width=5%}](https://society-rse.org)
